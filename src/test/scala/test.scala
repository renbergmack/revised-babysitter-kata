...
class BabysitterTest extends FlatSpec with BabysitterTools {
  ...
  "timeIsBetweenMidnightAndEndCutoff" should "return true if start is after midnight and before end cutoff" in {
    timeIsBetweenMidnightAndEndCutoff() should be (true)
  }
  ...
  "hoursWorkedBetweenMidnightAndEnd" should "return correct pay between midnight and end" in {
    val end: Int = 4
